		...
		sequences: [
			{
				...
				enemies: [
					...
					{
						type: 'enemy0',
						points: [[1.874, -7.677, -8.328], [3.49, 6.398, -7.157]],
						movement: 'single'
					}
				]
			},
			{
				...
				enemies: [
					{
						type: 'enemy0',
						points: [[-0.0, -8.839, -10.754], [-0.0, 6.865, -9.169]],
						movement: 'single'
					},
					{
						type: 'enemy0',
						points: [[-4.72, -11.803, -9.161], [-6.315, 5.616, -7.575]],
						movement: 'single'
					},
					{
						type: 'enemy0',
					...
					{
						type: 'enemy1',
						points: [[-0.0, -4.957, -9.048], [0.0, 2.312, -7.866]],
						movement: 'single'
					}
				]
			},
			...
			},
			{
				...
				enemies: [
					{
						type: 'enemy0',
						points: [[3.269, -4.923, -7.35], [5.26, 7.431, -5.765]],
						movement: 'single'
					},
					{
						type: 'enemy0',
						points: [[-3.277, -4.923, -7.35], [-5.267, 7.431, -5.765]],
						movement: 'single'
					},
					{
						type: 'enemy0',
