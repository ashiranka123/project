...
window.AFRAME.registerComponent('collision-helper', {
  schema: {
  ...
  init: function () {
    ...
    this.geometry = new window.THREE.IcosahedronGeometry(1, 1);
    this.material = new window.THREE.MeshBasicMaterial({color: data.color, wireframe: true});
  ...
  createHelperMesh: function () {
    ...
    this.helperMesh = new window.THREE.Mesh(this.geometry, this.material);
