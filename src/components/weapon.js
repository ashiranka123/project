 ...
 */
window.AFRAME.registerComponent('weapon', {
  ...
  updateWeapon: function () {
    ...
    if (this.controllerModel === 'oculus-touch-controller') {
      this.model.applyMatrix(new window.THREE.Matrix4().makeRotationAxis(new window.THREE.Vector3(1, 0, 0), 0.8));
  ...
  init: function () {
    ...
    el.addEventListener('model-loaded', function (evt) {
      ...
      var modelWithPivot = new window.THREE.Group();
